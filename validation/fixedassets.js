...
module.exports = function validateFixedassetsInput(data) {
  ...
  data.deprerate = !isEmpty(data.deprerate) ? data.deprerate : 0
  data.residamount = !isEmpty(data.residamount) ? data.residamount : 0
  data.usefulyears = !isEmpty(data.usefulyears) ? data.usefulyears : 0
  data.assetcost = !isEmpty(data.assetcost) ? data.assetcost : 0
  data.purchasedate = !isEmpty(data.purchasedate) ? data.purchasedate : Date.now
  ...
  if (typeof data.purchasedate == Date) {
    errors.purchasedate = 'Purcahse date must be date'
  }
